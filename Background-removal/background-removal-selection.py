...
# MOG2
# on intial run this one is better
...
camera = cv2.VideoCapture("../fruitloop.mp4")

# can we tell it to include white in the background
...
while True:
    ...
    treshold = cv2.adaptiveThreshold(foreground_mask.copy(),255,cv2.ADAPTIVE_THRESH_MEAN_C,
