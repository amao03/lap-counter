# https://github.com/nitish-gautam/YOLOv3-video-detection/blob/master/yolov3-video-detection.py
...
with open('extra-files/yolov3.txt') as f:
...
network = cv2.dnn.readNetFromDarknet('extra-files/yolov3.cfg',
                                     'extra-files/yolov3.weights')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('results/result-swim2.mp4', fourcc, 30,
